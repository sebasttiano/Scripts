...
class GameFieldView:
    """
    Виджет игрового поля, который отображает его, а также выясняет место клика
    """
    def __init__(self, field):
        # загрузить картинки значков клеток, отобразить первичное поле
        self._field = field
...
class GameWindow:
    """
    Содержит виджет поля, а также менеджера игового раунда.
    """
    def __init__(self):
